package com.journals.jenvoh.ui.adapter;
...
import com.journals.jenvoh.R;
import com.journals.jenvoh.databinding.VolumeIssueItemBinding;
import com.journals.jenvoh.model.VolumeIssueResponse;

import java.util.List;

import static com.journals.jenvoh.helper.utils.viewInBrowser;
...
public class VolumeIssueAdapter extends RecyclerView.Adapter<VolumeIssueAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull VolumeIssueAdapter.ViewHolder holder, int position) {
        ...
        if (modelList.get(position).getAuthorNames() != null){
